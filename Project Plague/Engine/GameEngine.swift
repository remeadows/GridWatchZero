...
final class GameEngine: ObservableObject {
    ...
    private func processTick() {
        ...
        // Step 6: Sink processes its buffer and generates credits (apply event + prestige multipliers)
        let baseCredits = sink.process()
        let credits = baseCredits * creditMultiplier * prestigeState.creditMultiplier
